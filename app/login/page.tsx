...
export default function LoginPage() {
  return (
    <div className=" min-h-svh flex flex-col items-center lg:items-end justify-center gap-6 p-6 md:p-10
    bg-[url('/Sfu-login-bg.avif')] bg-cover bg-center bg-no-repeat" >
      <div className="hidden lg:block absolute left-9 top-1/3 max-w-md text-white space-y-4 lg:left-16 animate-fadeIn slide-in-left">
